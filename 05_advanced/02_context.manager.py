"""
   ...
   - 블록을 벗어날 때 자동으로 close 처리 해줌(직접 f.close()불필요)
"""
import os #운영체제와 상호작용하여 파일 경로 탐색, 폴더 생성/삭제, 환경 변수 조회 등
import json #json 관련 변환 기능 제공하는 모듈 (json <--> dict/list)
...
with open(TXT_PATH, "w", encoding="utf-8") as f:
    f.write("금요일,20260911,걱정\n")
    f.write("토요일,20260911,기쁨\n")
...
products = [
    ...
    {"code": "003123", "name": "Galaxy Z Flip8 (플립8)", "price": 1600000},
]
