...
print('-'*60)    
"""
# 파이썬 리스트는 데이터 구분하지 않고 담을 수 있는 점이 편리하지만
# 다른 리스트와 연산 하고자 할 때는 문제 될 수 있음
...
# 넘파이 배열은 자바 배열과 비슷하지만
# 연산 수행 시 반복문 사용하지 않고 배열 단위 연산 가능 (백터화 연산)
