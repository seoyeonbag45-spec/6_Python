...
"""
import numpy as np
# 0~11 까지 데이터 포함 1차원 배열 생성
print(F"0부터 11까지 정수 생성하여 배열 생성 : {np.arange(12)}")
#=
arr = np.arange(12)
print(f"arr : {arr}")
...
arr_1d_2 = arr_3d.flatten()
print(f"flatten : {arr_1d_2}")

#ravel 이 복사본 반환 경우
#메모리가 연속적 배치된 경우만 뷰 반환
#메모리가 불연속적인 경우 복사본 반환
